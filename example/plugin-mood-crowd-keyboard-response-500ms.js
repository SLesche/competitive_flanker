var jsPsychMoodOfCrowdResponse = (function (jspsych) {
    ...
    const info = {
        ...
        parameters: {
            ...
            /** How long to show the mask.*/
            mask_duration: {
           type: jspsych.ParameterType.INT,
           pretty_name: "Mask duration",
           default: 4500, // 5000 ms Trial - 500 ms Stimulus
},
        ...
        trial(display_element, trial) {
            ...
            var response = {
                ...
                key: null,
                    ...
                    // Funktion zum Anzeigen der Maske
const displayMask = () => {
    ...
    mask.style.top = "0";
    mask.style.left = "0";
    mask.style.backgroundColor = "#ffffff"; // Weiß
    display_element.insertBefore(mask, null);
};
...
const end_trial = () => {
    ...
    // Display mask after stimulus_duration
    this.jsPsych.pluginAPI.setTimeout(() => {
        // Add code to display mask here
        displayMask();

        // Continue with the rest of the trial
        continue_trial();
    }, trial.stimulus_duration);

    // Function to continue with the rest of the trial after displaying mask
    const continue_trial = () => {
    ...
    // Set timeout for the entire trial duration
    this.jsPsych.pluginAPI.setTimeout(() => {
        continue_trial();
